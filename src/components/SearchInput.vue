...
<template>
  <div>
    ...
    <form @submit.prevent="onSubmit">
      <div
        class="bg-transparent border border-white rounded-4xl px-3 flex items-center"
      >
        <!-- Icon -->
        <svg
          width="30px"
    ...
    >
      <div v-for="place in searchTerm.results" :key="place.id">
        <button
          @click="getWeather(place, place.id)"
          class="border-b w-full text-left p-1.5 my-2 hover:text-green-200 hover:font-bold focus:white focus:border-2"
        >
