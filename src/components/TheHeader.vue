...
<template>
  ...
  <header class="bg-black/70 px-6 py-2.5 grid grid-cols-3 items-center">
    ...
    <!-- TODO: Add the ability to switch between C and F -->
    <div>
    </div>
  </header>
</template>